      ...
      <main className="flex-1 pattern-444">
        <div className="container px-4 py-12 relative z-10">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-5xl font-bold mb-6">About Soulfly</h1>
            ...
            <div className="space-y-8 text-lg leading-relaxed">
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  We create premium streetwear that speaks to those who walk with purpose, pray with intention, 
              ...
              <section className="pt-8 border-t">
                ...
                <p className="text-muted-foreground">
                  Soulfly is more than a brand—it's a community of believers who understand that 
                  style and spirituality aren't opposites, they're complements. Follow our journey, 
                  share your story, and wear your faith proudly.
                </p>
              </section>
            </div>
          </div>
